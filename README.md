...
```
this sets up the w3 Super Cache plugin and would be highly recommended. More info: https://docs.bitnami.com/kubernetes/apps/wordpress/configuration/understand-htaccess/
