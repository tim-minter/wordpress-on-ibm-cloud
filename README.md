...
```--set memcached.enabled=true ``` this sets up the w3 Super Cache plugin and would be highly recommeded. Info here https://docs.bitnami.com/aws/apps/wordpress/troubleshooting/optimize-bitnami-wordpress/
